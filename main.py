...
TOKEN = "6287904308:AAHMZaobTVOFUkQ7PwnGVkd8JQhsXDx9iTU"
...
channel_id = "-1001637978981"
group_id = "-1001979897783"
...
(
    [
        [
            InlineKeyboardButton("Share Content", url="https://t.me/WorldOfFeminismContentBot")
        ]
    ]
)
...
async def start(update, context):
    ...
    await bot.send_message(
        chat_id=chat_id,
        text=
        "राम राम\nThis bot is owned by @WorldOfFeminism for sticky message purpose. Made by @Yuyutsu101."
    )
